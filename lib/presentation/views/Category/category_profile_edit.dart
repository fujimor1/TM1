...
//           listener: (context, state) {
//             if (state is FotoTrabajoUploading) {
...
//                         onPressed: _newImageFile == null && _currentIndex > 0 ? _previousImage : null,
//                       ),
...
//                         onPressed: _newImageFile == null && _fotos.isNotEmpty && _currentIndex < _fotos.length - 1
//                             ? _nextImage
//                             : null,
//                       ),
//                     ],
...
//                       onPressed: _fotos.isNotEmpty && _newImageFile == null ? () {} : null,
...
//                         padding: const EdgeInsets.symmetric(vertical: 12.0),
//                       ),
//                       child: const Text('Eliminar foto', style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontWeight: FontWeight.w900)),
//                     ),
//                   ),
//                   const SizedBox(height: 8.0),
//                   SizedBox(
//                     width: double.infinity,
//                     child: ElevatedButton(
//                       onPressed: _newImageFile != null && !_isUploading ? _uploadImage : null,
//                       style: ElevatedButton.styleFrom(
